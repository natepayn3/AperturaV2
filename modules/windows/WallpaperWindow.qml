...
PanelWindow {
    ...
    Item {
        id: animatedGroup
        width: parent.width
        height: wallpaperWindow.active ? 600 : 0
        ...
        Item {
            ...
            Item {
                ...
                Timer {
                    ...
                    onTriggered: {
                        if (carousel.isKeyboarding) { stop(); return; }
                        if (direction === -1) carousel.decrementCurrentIndex();
                        else if (direction === 1) carousel.incrementCurrentIndex();
                    }
                }
                ...
                Item {
                    ...
                    HoverHandler {
                        onHoveredChanged: {
                            ...
                            } else if (hoverScrollTimer.direction === -1) hoverScrollTimer.stop();
                        }
                    }
                }
                ...
                PathView {
                    ...
                    property real baseItemWidth: 300 // Increased from 235
                    property real itemGap: -100      // Adjusted to compensate for wider cards
                    property real cardSkew: 60       // Reduced from 130
                    ...
                    WheelHandler {
                        onWheel: (event) => {
                            ...
                            if (event.angleDelta.y > 0 || event.angleDelta.x > 0) carousel.decrementCurrentIndex();
                            else if (event.angleDelta.y < 0 || event.angleDelta.x < 0) carousel.incrementCurrentIndex();
                        }
                    }
